...
function ListTable({ flights }) {
  ...
  const emptyRows = rowsPerPage - Math.min(rowsPerPage, flights.length - page * rowsPerPage);
      ...
      <Paper className={classes.paper}>
        <TableContainer>
          ...
          >
            ...
            />
            <TableBody>
              {flights.length ? stableSort(flights, getSorting(order, orderBy))
        ...
        <TablePagination
          ...
          page={flights.length < rowsPerPage ? 0 : page}
